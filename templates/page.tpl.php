...
<div id="wrap" class="clr container <?php print $wrap_class; ?>">
  <div id="header-wrap" class="clr fixed-header">
    <header id="header" class="site-header clr">
     <?php if ($page['header']): ?>
        <div class="span_1_of_1 col col-1 header-content">
      ...
      <?php if (theme_get_setting('socialicon_display', 'ailla')): ?>
      <?php
      $twitter_url = check_plain(theme_get_setting('twitter_url', 'ailla'));
      $facebook_url = check_plain(theme_get_setting('facebook_url', 'ailla'));
      $google_plus_url = check_plain(theme_get_setting('google_plus_url', 'ailla'));
      $pinterest_url = check_plain(theme_get_setting('pinterest_url', 'ailla'));
      ?>
      <?php endif; ?>
